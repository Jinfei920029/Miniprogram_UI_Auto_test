...
class login_def():
    ...
    def miniprogram_login(self, t=500):
        """简单登录，注销测试"""
        time.sleep(3)
    ...
    def miniprogram_logout(self,t=500):
        time.sleep(3)
        window = self.driver.get_window_size()
        x1 = window['width'] * 0.5  # 起始x坐标
        y1 = window['height'] * 0.2  # y1坐标，滑动起始点
    ...
    def text_exist(self,xpath,text1):
        text2 = self.driver.find_element_by_xpath(xpath).get_attribute('text')
        while text2 == text1:
